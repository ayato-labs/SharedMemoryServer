...
async def test_klm_cascading_visibility_integration(mock_llm):
    ...
    await logic.save_memory_core(entities=[{"name": "Alpha", "description": "A"}, {"name": "Beta", "description": "B"}])
    await logic.save_memory_core(relations=[{"subject": "Alpha", "object": "Beta", "predicate": "leads_to"}])
